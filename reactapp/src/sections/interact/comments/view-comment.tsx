...
import { CommentTableRow } from '../../interact/comments/comment-table-row';
import { CommentTableHead } from '../../interact/comments/comment-table-head';
    ...
    <DashboardContent>
      <Card sx={{ width: '100%', height: '100%' }}>
        <Scrollbar sx={{ width: '100%', height: 'auto', maxHeight: 'none' }}>
          <TableContainer sx={{ width: '100%', height: 'auto', overflow: 'visible' }}>
            <Table sx={{ minWidth: 1200 }}>
              <CommentTableHead
                ...
                headLabel={[
                  { id: 'id', label: 'ID' },
                  { id: 'user_id', label: 'Tên' },
                  { id: 'film_id', label: 'Tên phim' },
                  { id: 'comment', label: 'Bình luận' },
                  { id: 'is_block', label: 'Khoá' },
